...
SCPT_DIR="/etc/SCRIPT"
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2VkZHlqaG9lbGRldi9nZXQvbWFzdGVyL2dlcmFkb3I="
SUB_DOM='base64 -d'
rm $(pwd)/$0
ofus () {
unset txtofus
...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/eddyjhoeldev/get/master/Install/trans &> /dev/null
...
echo -e "\033[1;36m--------------------------------------------------------------------\033[0m"
echo -e "\033[1;33m Key no valida!"
echo -e "\033[1;36m--------------------------------------------------------------------\033[0m"
}
echo -ne "\033[0m"
